...
(defonce app-db {:style-mode styles/dark-mode
                 ...
                 :resources {0 {:id 0
                             ...
                             1 {:id 1
                                :type :equipment
                                :name "Example Equipment (Sword)"
                                :properties [:sword :medium :slashing :piercing]
                         ...
                         ;;     Armor
                             ...
                             3 {:id 3
                                :type :expertise
                                :name "Example Expertise (Soldier)"
                             ...
                             300 {:id 300
                                  :type :expertise
                                  :name "Mercenary"
                                  :properties [:experience :fighting-style ]
                                  :benefits {:quality {:name "Knowledge"
                                                       :value 1}
                                             :power {:name "Practice"
                                                     :value 1}}
