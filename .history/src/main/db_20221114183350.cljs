                 ...
                 :resources {145 {:id 145
                             ...
                             300 {:id 300
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 1}}
                                  :details "Gain +Skill +Equipment on checks that use a light weapon, shield, or armor. Gain +Skill +Equipment on checks to move stealthily and to cover your tracks and on checks to contest another creature moving stealthily or covering their tracks."}
                             301 {:id 301
                                  :editable? true
                                  :type :expertise
                                  :name "Soldier"
                             ...
                             303 {:id 303
                                  ...
                                  :benefits {:quality {:name "Knowledge"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 1}}
                                  :details "Gain +Skill +Equipment on checks that use Artifacts. Additionally, you have been taught the three fundamental glyph patterns: Connection, Imbuement, and Transmutation. These are the underlying patterns to most glyphs used by Arcanists. This allows you to acquire glyphs as additional resources."}
                             310 {:id 310
                                  :editable? true
                                  :type :expertise
                                  :name "Druid"
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 2}}
                                  :details "Gain +Skill +Equipment on checks that use Totems. Additionally, you can make an Instinct +Skill +Equipment check to communicate roughly with plants and animals. The more distant the relation between the plant or animal and your race, the higher the target number becomes."}
                             311 {:id 311
                                  :editable? true
                                  :type :expertise
                                  :name "Invoker"
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 3}}
                                  :details "Gain +Skill +Equipment on checks that use Relics. Additionally, you have a pledge or contract with some deity or power that you channel. Once per day, you may make an Exertion +Skill +Equipment check to commune with whatever deity or power you are bound to and request access to an invocation. The invocations available to you will depend on the deity or power you are bound to."}
                             312 {:id 312
                                  :editable? true
                                  :type :expertise
