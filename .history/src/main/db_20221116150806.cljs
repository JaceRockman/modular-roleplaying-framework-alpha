...
(defonce app-db {:style-mode styles/dark-mode
                 ...
                 :resources {145 {:id 145
                                  ...
                                  :benefits {:quality {:name "Quality"
                                                       :value 0}
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to climb a surface."}
                             146 {:id 146
                                  :editable? true
                                  :type :equipment
                                  :name "Forgery Kit"
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to duplicate text."}
                             147 {:id 147
                                  :editable? true
                                  :type :equipment
                                  :name "Lockpick Set"
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to open locks or disable traps."}
                             148 {:id 148
                                  :editable? true
                                  :type :equipment
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these documents to recall information related to the topic of these documents."}
                             149 {:id 149
                                  :editable? true
                                  :type :equipment
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to determine your current location and orientation."}
                             150 {:id 150
                                  :editable? true
                                  :type :equipment
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to create small mechanisms and trinkets"}
                             151 {:id 151
                                  :editable? true
                                  :type :equipment
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to brew alchemical mixtures."}
                             152 {:id 152
                                  :editable? true
                                  :type :equipment
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use this instrument in a musical performance."}
                             153 {:id 153
                                  :editable? true
                                  :type :equipment
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to measure and draw maps as well as checks that use a map to navigate an area."}
                             154 {:id 154
                                  :editable? true
                                  :type :equipment
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to create visual art."}
                             155 {:id 155
                                  :editable? true
                                  :type :equipment
                                  :name "Herbalism Kit"
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to create medicines."}
                             156 {:id 156
                                  :editable? true
                                  :type :equipment
                                  :name "Disguise Kit"
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Versatility"
                                                     :value 0}}
                                  :details "Gain +Quality +Versatility on checks that use these tools to disguise your appearance"}
                             ...
                             202 {:id 202
                                  ...
                                  :benefits {:quality {:name "Clarity"
                                             ...
                                             :power {:name "Dedication"
                                                     :value 0}}
                                  :details "Grants +Clarity +Dedication to checks that move you towards accomplishing your goal Checks that set you back with respect to your goal gain penalties equal to the Quality and Power of your goal. Circumstances may cause multiple traits to apply bonuses or penalties to a check. Ultimately, it is up to the DM's discretion whether a trait grants a bonus or penalty. Some examples of goals are to discover forgotten magics, wealth, or to be granted knighthood."}
                             203 {:id 203
                                  :editable? true
                                  :type :traits
                                  :name "Oath Template"
                             ...
                             300 {:id 300
                                  ...
                                  :benefits {:quality {:name "Skill"
                                                       :value 0}
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "The Scout Expertise includes a set of light armor, two daggers, a light melee weapon (shortsword, javelin, or handaxe), and a light ranged weapon (shortbow or hand crossbow). Gain +Skill +Equipment on checks that use these items. Additionally, gain +Skill +Equipment on checks to move stealthily and to cover your tracks and when contesting another creature's check to moving stealthily or cover their tracks."}
                             301 {:id 301
                                  :editable? true
                                  :type :expertise
                                  :name "Soldier"
                             ...
                             302 {:id 302
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "The Sentinel Expertise includes a set of heavy armor, a tower shield, and a heavy melee weapon (greatsword, lance, or greataxe). Gain +Skill +Equipment on checks that use these items. Additionally, if a target creature within the same zone as you is attacked and you are wielding your tower shield, you can make a Physical +Skill +Equipment check against that attack. The result of your defense check is inflicted as a flat penalty on the attack roll. The target of the attack may still make their own defense check if needed."}
                             303 {:id 303
                                  :editable? true
                                  :type :expertise
                                  :name "Arcanist"
                                  ...
                                  :benefits {:quality {:name "Knowledge"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "The Arcanist Expertise includes a rune of protection, an arcanist's quill, and an aether bow. Gain +Skill +Equipment on checks using these items. The rune of protection helps resist attacks that target your spirit. You have been taught the three fundamental glyph patterns and can inscribe them using the arcanist's quill: Connection, Imbuement, and Transmutation. The glyph of connection can be used to connect various physical features of two objects with one another: temperature, motion, weight, and luminosity. The glyph of imbuement can be used to enhance a creature's capabilities in each of the domains: physical, spiritual, mental, and social. The glyph of transmutation can temporarily change the material an object is constructed from, the more similar the materials are, the easier it is for the glyph to function."}
                             310 {:id 310
                                  :editable? true
                                  :type :expertise
                                  :name "Druid"
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "The Druid Expertise includes a tattoo of protection, a totem of your nature sign (one of the four elements, a tree, the moon, the sun, etc.), and a staff of elemental control (earth, water, air, or fire). Gain +Skill +Equipment on checks that use these items. The tattoo of protection helps resist attacks that target your spirit. The staff of elemental control allows you to make a Spiritual +Skill +Equipment check to make a ranged attack using the element of your choice. Your totem allows you to make an Spiritual +Skill +Equipment check to commune with plants or creatures related to your nature sign. The more closely related to your nature sign, the easier the check becomes."}
                             311 {:id 311
                                  :editable? true
                                  :type :expertise
                                  :name "Invoker"
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "The Invoker Expertise includes a talisman of protection, a relic of your pact being, a written copy of your contract, and a physical manifestation of your pact being's influence that is shared amongst all followers of that pact being (a unique eye or hair color, a symbol on your forehead, a discoloration of your skin, etc.). Gain +Skill +Equipment on checks that use these items. The talisman of protection helps resist attacks that target your spirit. The written copy of your contract includes an invocation that allows you to make a Spiritual +Skill +Equipment check to make a ranged attack against a targeted creature. Additionally, once per day, you may make a Spiritual +Skill +Equipment check to commune with whatever deity or power you are bound to and request access to a intercession."}
                             312 {:id 312
                                  :editable? true
                                  :type :expertise
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "Gain +Skill +Equipment on checks to recall information related to (Topic)."}
                             313 {:id 313
                                  :editable? true
                                  :type :expertise
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "Gain +Skill +Equipment on checks to gather information about (Topic). This can be through multiple means such as experimentation, locating sources of information, or interpreting those sources of information. If a check to gain information fails, you will at least gain some idea of where you need to go in order to gain the information."}
                             314 {:id 314
                                  :editable? true
                                  :type :expertise
                                  :name "Noble"
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "The Noble Expertise includes a sigil of a noble house (ring, amulet, brooch, etc.) and clothes befitting a noble court. Gain +Skill +Equipment on checks related to passing as well-mannered nobility and to identify the social faux paus of others trying to come across as well-mannered nobility. This includes knowledge of social decorum, family ties, and any relevant political tensions."}
                             315 {:id 315
                                  :editable? true
                                  :type :expertise
                                  :name "Storyteller"
                             ...
                             316 {:id 316
                                  ...
                                  :benefits {:quality {:name "Skill"
                                             ...
                                             :power {:name "Equipment"
                                                     :value 0}}
                                  :details "Gain +Skill +Equipment on checks to convince or inspire others to do what you want them to do as well as on checks to determine if others are being truthful with you."}
                             ...
                             400 {:id 400
                                  ...
                                  :benefits {:quality {:name "Reach"
                                             ...
                                             :power {:name "Influence"
                                                     :value 0}}
                                  :details "Gain +Reach +Influence on Social checks while interacting with this individual. The Game Master may give partial bonuses on social checks where this individual is a mutual acquaintance. Examples of individuals that you may be affiliated with are allies, friends, mentors, or family."}
                             401 {:id 401
                                  :editable? true
                                  :type :affiliations
                                  :name "Group Template"
                                  ...
                                  :benefits {:quality {:name "Reach"
                                             ...
                                             :power {:name "Influence"
                                                     :value 0}}
                                  :details "Gain +Reach +Influence on Social checks while interacting with this group. The Game Master may give partial bonuses on social checks where this group is a relevant. Examples of groups that you may be affiliated with are guilds, religious orders, schools, or communities."}
                             402 {:id 402
                                  :editable? true
                                  :type :affiliations
                             ...
                             500 {:id 500
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Power"
                                                     :value 1}}
                                  :details "Gain +Quality +Power on a Physical check to throw this bottle at a target creature. If the attack is successful, then inflict a physical minor wound with acid damage."}
                             501 {:id 501
                                  :editable? false
                                  :type :items
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Power"
                                                     :value 1}}
                                  :details "Gain +Quality +Power on a Physical check to throw this bottle at a target creature. If the attack is successful, then inflict a physical minor wound with fire damage."}
                             502 {:id 502
                                  :editable? false
                                  :type :items
                                  :name "Antitoxin"
                             ...
                             505 {:id 505
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Power"
                                                     :value 0}}
                                  :details "A metal lock that can be broken with a Physical attack result of 10 or can be picked with a Physical check using lockpicking tools and a target number of 7."}
                             507 {:id 507
                                  :editable? false
                                  :type :items
                                  :name "Manacles"
                             ...
                             509 {:id 509
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Power"
                                                     :value 0}}
                                  :details "When ingested, the creature must make a Physical check with a target number of 8. If they are unsuccessful, they gain the poisoned condition for the next 24 hours."}
                             510 {:id 510
                                  :editable? false
                                  :type :items
                                  :name "Healing Potion"
                             ...
                             511 {:id 511
                                  ...
                                  :benefits {:quality {:name "Quality"
                                             ...
                                             :power {:name "Power"
                                                     :value 2}}
                                  :details "Gain +Quality +Power on a Physical check to restrain a creature. The creature must break free with a Physical check -Quality -Power where the target number is equal to the initial Physical check you made."}}
...
(def fillias-chest
  {:resources {11101 {:id 11101, :editable? false :type :equipment, :name "Cloak of Protection from Evil", :properties [], :benefits {:quality {:name "Quality", :value 1}, :power {:name "Power", :value 3}}, :details "Grants +Quality +Power on rolls to protect yourself from actions made out of malicious intent."} 11102 {:id 11102 :editable? false :type :item :name "Healing Stone" :properties [] :benefits {:quality {:name "Quality", :value 0}, :power {:name "Power", :value 0}} :details "Heals a minor wound once per day."} 11103 {:id 11103, :editable? false :type :equipment, :name "Shortsword of Teleportation", :properties [], :benefits {:quality {:name "Balance", :value 3}, :power {:name "Lethality", :value 2}}, :details "You may spend a main action to make a Coordination +Balance +Lethality check against a creature. You must have the creature targeted and the creature must be in the same zone as you. As a light weapon, it may be wielded in either hand. When partitioning the base dice pool, the resulting dice pools must have at least two dice in them. This weapon may deal piercing or slashing damage. Once per day, on a successful hit, you may teleport yourself and the affected creature up to 3 zones away."}}})

(def glendas-chest
  {:resources {11101 {:id 11101, :editable? false :type :equipment, :name "Cloak of Protection from Evil", :properties [], :benefits {:quality {:name "Quality", :value 1}, :power {:name "Power", :value 3}}, :details "Grants +Quality +Power on rolls to protect yourself from actions made out of malicious intent."}}})

(def reginalds-drawer
  {:resources {22201 {:id 22201, :editable? false :type :equipment, :name "Aether-reaching Dagger", :properties [], :benefits {:quality {:name "Balance", :value 4}, :power {:name "Lethality", :value 3}}, :details "You may spend a main action to make a Coordination +Balance +Lethality check against a creature. You must have the creature targeted and the creature must be in the same zone as you. As a light weapon, it may be wielded in either hand. When partitioning the base dice pool, the resulting dice pools must have at least two dice in them. This weapon deals Spiritual injuries instead of Physical injuries."} 22202 {:id 22202, :editable? false :type :equipment, :name "Ring of Isolation", :properties [], :benefits {:quality {:name "Quality", :value 2}, :power {:name "Power", :value 2}}, :details "Grants +Quality +Power on rolls to protect yourself from binding magics."}}})

(def chess-puzzle
  {:resources {33301 {:id 33301, :editable? true
                      :type :equipment, :name "", :properties [], :benefits {:quality {:name "Quality", :value 0}, :power {:name "Power", :value 0}}, :details ""}}})

;; Resources discarded for the Simple Characters
;;     100 {:id 100
                         ;;          :type :equipment
                         ;;          :name "Dagger"
...
;;                  :power {:name "Power"
;;                          :value 0}}
;;       :details "A metal lock that can be broken with a physical attack result of 10 or can be picked with a Coordination check using thieves' tools and a target number of 7."}
;;  507 {:id 507
;;       :type :items
;;       :name "Manacles"
;;       :properties [:item]
...
;;                  :power {:name "Power"
;;                          :value 0}}
;;       :details "Metal manacles that can be be placed on a creature to give it the restrained condition that inflicts a -3d penalty on checks that require the use of your hands or feet, whichever is restrained. These can be broken with a physical attack result of 10 or can be picked with a Coordination check using thieves' tools and a target number of 7."}
;;  509 {:id 509
;;       :type :items
;;       :name "Poison"
;;       :properties [:item]
