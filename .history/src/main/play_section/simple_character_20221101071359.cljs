...
(defn simple-stat
  ...
  (let [stat-name (string/capitalize (name domain))
    ...
    (widgets/flat-button {:key helpers/new-key
                          :style {:height 100 :width 175 :justify-content :center :flex-direction :column :padding 5 :border-width 1 :border-color :white}
                          ...
                          :text [:> rn/View {:style {:flex-direction :row}}
                                 ...
                                 [:> rn/View {:style {:flex-direction :justify-content :center :column :margin-left 5 :margin-right 5}}
