...
(defn character-stats-and-resources
  ...
  [:> rn/View {:style {:width "100%" :padding-bottom 15}}
   ...
   [:> rn/View {:style {:flex-direction :row}}
    ...
    [:> rn/Text {:style {:align-self :flex-start :color :white :padding-right 110}} "Stats"]
    [:> rn/Text {:style {:align-self :flex-start :color :white :padding-right 110}} "Damage"]
    [:> rn/Text {:style {:align-self :flex-start :color :white :padding-right 8}} "Resources"]]
