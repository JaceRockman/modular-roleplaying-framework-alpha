...
(defn simple-stat-row
  ...
  [:> rn/View {:key (helpers/new-key)
   ...
   (if damage?
     ...
     [:> rn/View {:width 100}])
   [:> rn/ScrollView {:style {:height 95 :width 350 :horizontal true :border-width 0 :margin-top -10 :nested-scroll-enabled true}
                      :content-container-style {:align-items :center :justify-content :center :flex-direction :row :overflow :visible}} 
