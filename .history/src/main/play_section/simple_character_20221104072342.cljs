...
(defn character-stats-and-resources
  ...
  [:> rn/View {:style {:width "100%" :padding-bottom 15}}
   ...
   [:> rn/View {:style {:flex-direction :row}}
    ...
    [:> rn/Text {:style {:align-self :flex-end :color :white :padding-right 8}} "Stats"] 
    [:> rn/Text {:style {:align-self :flex-end :color :white :padding-right 8}} "Damage"]
    [:> rn/Text {:style {:align-self :flex-end :color :white :padding-right 8}} "Resources"]]
