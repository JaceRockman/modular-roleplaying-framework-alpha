...
(defn character-stats-and-resources
  ...
  [:> rn/View {:style {:width "100%" :padding-bottom 15}}
   ...
   [:> rn/View {:style {:flex-direction :row}}
    ...
    [:> rn/Text {:style {:align-self :flex-start :color :white :text-align :center :width 175}} "Stats"]
    [:> rn/Text {:style {:align-self :flex-start :color :white :text-align :center :width 150}} "Damage"]
