...
(defn character-profile-edit
  ...
  [:> rn/View {:style {:margin-bottom 15}}
   (widgets/text-area #(>evt [:update-character-profile char-id (keyword (string/lower-case "gender")) (str %)])
                      ((keyword (string/lower-case "gender")) (<sub [:character-profile char-id]))
                      "gender")
