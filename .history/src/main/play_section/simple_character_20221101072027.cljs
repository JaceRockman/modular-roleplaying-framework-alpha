...
(defn damage-tracker
  [char-id domain]
  [:> rn/View {:style {:flex-direction :row :width 300 :height 90 :align-items :center :justify-content :center :border-width 1 :border-color :white :padding-top 10 :margin-left 1}}
   (widgets/incrementor
