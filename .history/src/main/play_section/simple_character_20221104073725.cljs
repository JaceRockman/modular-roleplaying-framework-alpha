...
(defn character-stats-and-resources
  ...
  [:> rn/View {:style {:width "100%" :padding-bottom 15}}
   ...
   [:> rn/View {:style {:flex-direction :row}}
    ...
    [:> rn/Text {:style {:align-self :flex-start :color :white :padding-left 50 :padding-right 50}} "Stats"]
    [:> rn/Text {:style {:align-self :flex-start :color :white :padding-left 50 :padding-right 50}} "Damage"]
    [:> rn/Text {:style {:align-self :flex-start :color :white :padding-left 50 :padding-right 50}} "Resources"]]
