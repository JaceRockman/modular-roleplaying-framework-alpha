     ...
     (widgets/flat-button {:key helpers/new-key
                           ...
                           :text [:> rn/View {:style {:flex-direction :row}}
                                  ...
                                  [:> rn/View {:style {:flex-direction :column :margin-left 5 :margin-right 5}}
                                   [:> rn/Text {:style {:font-size 12 :color :white}} resource-name]
                                   [:> rn/Text {:style {:font-size 18 :color :white}} (helpers/formatted-skill-bonus resource-quality resource-power)]]
                                  [:> rn/View {:style {:flex-direction :column}}
                                   ...
                                   (widgets/flat-button {:style {:display (if (<sub [:edit-mode]) "flex" "none") :width 25 :height 25 :padding 0}
                                                         ...
                                                         :text-style {:font-size 10 :height 25 :top 7}
                                                         :text (:down-sm widgets/common-icons)})]]})
     (widgets/flat-button {:text resource-name})
     (widgets/flat-button {:text resource-quality})
     (widgets/flat-button {:text resource-power})]))
...
(defn simple-stat-row
  ...
  [:> rn/View {:key (helpers/new-key)
   ...
   (if damage?
     ...
     [:> rn/View {:width 100}])
   (map resource (repeat char-id) (<sub [(resource-subs domain) char-id]))])
