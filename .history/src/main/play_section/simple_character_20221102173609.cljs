...
(defn simple-stat-row
  ...
  [:> rn/View {:key (helpers/new-key)
   ...
   (if damage?
     ...
     [:> rn/View {:width 100}])
   [:> rn/View {:style {:height 90 :overflow :visible :flex-direction :horizontal}}
    [:> rn/ScrollView {:style {:horizontal true :overflow :visible :border-width 0 :margin-top -3
                              :content-container-style {:width 5000}}} (doall (map resource (repeat char-id) (repeat domain) (<sub [(resource-subs domain) char-id])))]]])
